    ...
    render() {
        return(
            <div className={style.select}>
                <div className={style.select__notification}>
                    ...
                    <p className={style.select__notification__text}>select katana year</p>
                </div>
                <div className={style.select__year}>
                    {/* потом вернуть в тег <a/>*/}
                    <div  className={style.select__year__href}>1970</div>
                    <div  className={style.select__year__href}>1970</div>
                    <div  className={style.select__year__href}>1970</div>
                    <div  className={style.select__year__href}>1970</div>
                    <div  className={style.select__year__href}>1970</div>
